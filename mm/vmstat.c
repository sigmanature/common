...
#undef OFF
	...
	[I(PGSTEAL_ORDER_KSWAPD)]		= "pgsteal_order0_kswapd",
	...
	[I(MIGRATE_FAIL_EAGAIN_LOCK)]		= "migrate_fail_eagain_lock",
	[I(MIGRATE_FAIL_EAGAIN_NOTUPTODATE)]	= "migrate_fail_eagain_notuptodate",
	[I(MIGRATE_FAIL_EAGAIN_BUFFERS)]	= "migrate_fail_eagain_buffers",
	[I(MIGRATE_FAIL_EAGAIN_MAPPED)]		= "migrate_fail_eagain_mapped",
	[I(MIGRATE_FAIL_MOVE)]			= "migrate_fail_move",
	[I(MIGRATE_BATCH_ENOMEM)]		= "migrate_batch_enomem",
	[I(MIGRATE_REFMISMATCH_TOTAL)]		= "migrate_refmismatch_total",
	[I(MIGRATE_REFMISMATCH_MISSING)]	= "migrate_refmismatch_missing",
	[I(MIGRATE_REFMISMATCH_EXTRA1)]		= "migrate_refmismatch_extra1",
	[I(MIGRATE_REFMISMATCH_EXTRA2)]		= "migrate_refmismatch_extra2",
	[I(MIGRATE_REFMISMATCH_EXTRA_GE3)]	= "migrate_refmismatch_extra_ge3",
	[I(MIGRATE_REFMISMATCH_PINNED)]		= "migrate_refmismatch_pinned",
	[I(MIGRATE_REFMISMATCH_SWAPCACHE)]	= "migrate_refmismatch_swapcache",
	[I(MIGRATE_REFMISMATCH_LARGE)]		= "migrate_refmismatch_large",
	[I(MIGRATE_REFMISMATCH_LOCKED)]		= "migrate_refmismatch_locked",
	[I(MIGRATE_REFMISMATCH_MAPPED)]		= "migrate_refmismatch_mapped",
	[I(MIGRATE_REFMISMATCH_UNKNOWN)]	= "migrate_refmismatch_unknown",
	[I(MIGRATE_MAPFREEZE_TOTAL)]		= "migrate_mapfreeze_total",
	[I(MIGRATE_MAPFREEZE_ANON_LARGE)]	= "migrate_mapfreeze_anon_large",
	[I(MIGRATE_MAPFREEZE_SWAPCACHE)]	= "migrate_mapfreeze_swapcache",
	[I(MIGRATE_MAPFREEZE_PAGECACHE)]	= "migrate_mapfreeze_pagecache",
	[I(ISO_SKIP_ORDER_FILTER)]		= "iso_skip_order_filter",
	[I(ISO_SKIP_BLOCK_BIT)]			= "iso_skip_block_bit",
	[I(ISO_SKIP_HUGEPAGE)]			= "iso_skip_hugepage",
	[I(ISO_SKIP_BUDDY)]			= "iso_skip_buddy",
	[I(ISO_SKIP_NOT_LRU)]			= "iso_skip_not_lru",
	[I(ISO_SKIP_PINNED_ANON)]		= "iso_skip_pinned_anon",
	[I(ISO_SKIP_UNEVICTABLE)]		= "iso_skip_unevictable",
	[I(ISO_SKIP_WRITEBACK_ASYNC)]		= "iso_skip_writeback_async",
	[I(ISO_SKIP_CLEAR_LRU_FAIL)]		= "iso_skip_clear_lru_fail",
	[I(ISO_SKIP_INACCESSIBLE)]		= "iso_skip_inaccessible",
	[I(FREE_SKIP_BLOCK_BIT)]		= "free_skip_block_bit",
