...
#undef OFF
	...
	[I(ALLOC_STALL_FRAGMENT)]		= "alloc_stall_fragment",
	[I(KCOMPACTD_TIMEOUT_WAKE)]		= "kcompactd_timeout_wake",
	[I(KCOMPACTD_WAKE_REQUEST)]		= "kcompactd_wake_request",
	[I(KCOMPACTD_WOKE_BY_ALLOC)]		= "kcompactd_woke_by_alloc",
	[I(KCOMPACTD_WOKE_BY_VMSCAN)]		= "kcompactd_woke_by_vmscan",
	[I(KCOMPACTD_ORDER2_LOW)]		= "kcompactd_order2_low",
	...
	[I(THP_ZERO_PAGE_ALLOC)]		= "thp_zero_page_alloc",
		...
		[I(ANON_MTHP_VMA_UNSUITABLE_ORDER2)]	= "anon_mthp_vma_unsuitable_order2",
		[I(COW_MTHP_ORDER2)]			= "cow_mthp_order2",
		[I(COW_MTHP_FALLBACK_ORDER0)]		= "cow_mthp_fallback_order0",
		[I(COW_MTHP_VMA_UNSUITABLE_ORDER2)]	= "cow_mthp_vma_unsuitable_order2",
		[I(ALLOC_FAIL_WMARK_ANON)]			= "alloc_fail_wmark_anon",
		[I(ALLOC_FAIL_WMARK_FILE)]			= "alloc_fail_wmark_file",
		[I(ALLOC_FAIL_FRAGMENT_ANON)]			= "alloc_fail_fragment_anon",
		[I(ALLOC_FAIL_FRAGMENT_FILE)]			= "alloc_fail_fragment_file",
		[I(ALLOC_STALL_WMARK_ANON)]			= "alloc_stall_wmark_anon",
		[I(ALLOC_STALL_WMARK_FILE)]			= "alloc_stall_wmark_file",
		[I(ALLOC_STALL_FRAGMENT_ANON)]			= "alloc_stall_fragment_anon",
		[I(ALLOC_STALL_FRAGMENT_FILE)]			= "alloc_stall_fragment_file",
		[I(VMA_ANON_ALLOC_ORDER0_TOTAL)]			= "vma_anon_alloc_order0_total",
		[I(VMA_ANON_ALLOC_ORDER2_TOTAL)]			= "vma_anon_alloc_order2_total",
		[I(VMA_ANON_ALLOC_ORDER0_ANON_FAULT)]			= "vma_anon_alloc_order0_anon_fault",
		[I(VMA_ANON_ALLOC_ORDER2_ANON_FAULT)]			= "vma_anon_alloc_order2_anon_fault",
		[I(VMA_ANON_ALLOC_ORDER0_SWAPIN)]			= "vma_anon_alloc_order0_swapin",
		[I(VMA_ANON_ALLOC_ORDER2_SWAPIN)]			= "vma_anon_alloc_order2_swapin",
		[I(VMA_ANON_ALLOC_ORDER0_COW)]			= "vma_anon_alloc_order0_cow",
		[I(VMA_ANON_ALLOC_ORDER2_COW)]			= "vma_anon_alloc_order2_cow",
		[I(VMA_ANON_ALLOC_ORDER0_FILE_COW)]			= "vma_anon_alloc_order0_file_cow",
		[I(VMA_ANON_ALLOC_ORDER2_FILE_COW)]			= "vma_anon_alloc_order2_file_cow",
		[I(VMA_ANON_ALLOC_ORDER0_UFFD_COPY)]			= "vma_anon_alloc_order0_uffd_copy",
		[I(VMA_ANON_ALLOC_ORDER2_UFFD_COPY)]			= "vma_anon_alloc_order2_uffd_copy",
		[I(VMA_ANON_ALLOC_ORDER0_UFFD_ZEROPAGE)]			= "vma_anon_alloc_order0_uffd_zeropage",
		[I(VMA_ANON_ALLOC_ORDER2_UFFD_ZEROPAGE)]			= "vma_anon_alloc_order2_uffd_zeropage",
		[I(VMA_ANON_ALLOC_ORDER0_CLASS_DALVIK)]			= "vma_anon_alloc_order0_class_dalvik",
		[I(VMA_ANON_ALLOC_ORDER2_CLASS_DALVIK)]			= "vma_anon_alloc_order2_class_dalvik",
		[I(VMA_ANON_ALLOC_ORDER0_CLASS_SCUDO)]			= "vma_anon_alloc_order0_class_scudo",
		[I(VMA_ANON_ALLOC_ORDER2_CLASS_SCUDO)]			= "vma_anon_alloc_order2_class_scudo",
		[I(VMA_ANON_ALLOC_ORDER0_CLASS_BIONIC)]			= "vma_anon_alloc_order0_class_bionic",
		[I(VMA_ANON_ALLOC_ORDER2_CLASS_BIONIC)]			= "vma_anon_alloc_order2_class_bionic",
		[I(VMA_ANON_ALLOC_ORDER0_CLASS_MTHP_VMA)]			= "vma_anon_alloc_order0_class_mthp_vma",
		[I(VMA_ANON_ALLOC_ORDER2_CLASS_MTHP_VMA)]			= "vma_anon_alloc_order2_class_mthp_vma",
		[I(VMA_ANON_ALLOC_ORDER0_CLASS_STACK)]			= "vma_anon_alloc_order0_class_stack",
		[I(VMA_ANON_ALLOC_ORDER2_CLASS_STACK)]			= "vma_anon_alloc_order2_class_stack",
		[I(VMA_ANON_ALLOC_ORDER0_CLASS_FILE_PRIVATE)]			= "vma_anon_alloc_order0_class_file_private",
		[I(VMA_ANON_ALLOC_ORDER2_CLASS_FILE_PRIVATE)]			= "vma_anon_alloc_order2_class_file_private",
		[I(VMA_ANON_ALLOC_ORDER0_CLASS_OTHER)]			= "vma_anon_alloc_order0_class_other",
		[I(VMA_ANON_ALLOC_ORDER2_CLASS_OTHER)]			= "vma_anon_alloc_order2_class_other",
		[I(FILE_ALLOC_ORDER0_TOTAL)]			= "file_alloc_order0_total",
		[I(FILE_ALLOC_ORDER2_TOTAL)]			= "file_alloc_order2_total",
		[I(FILE_ALLOC_ORDER0_UNKNOWN)]			= "file_alloc_order0_unknown",
		[I(FILE_ALLOC_ORDER2_UNKNOWN)]			= "file_alloc_order2_unknown",
		[I(FILE_ALLOC_ORDER0_READAHEAD)]			= "file_alloc_order0_readahead",
		[I(FILE_ALLOC_ORDER2_READAHEAD)]			= "file_alloc_order2_readahead",
		[I(FILE_ALLOC_ORDER0_GETFOLIO_MMAP)]			= "file_alloc_order0_getfolio_mmap",
		[I(FILE_ALLOC_ORDER2_GETFOLIO_MMAP)]			= "file_alloc_order2_getfolio_mmap",
		[I(FILE_ALLOC_ORDER0_GETFOLIO_WRITE)]			= "file_alloc_order0_getfolio_write",
		[I(FILE_ALLOC_ORDER2_GETFOLIO_WRITE)]			= "file_alloc_order2_getfolio_write",
		[I(FILE_ALLOC_ORDER0_GETFOLIO_OTHER)]			= "file_alloc_order0_getfolio_other",
		[I(FILE_ALLOC_ORDER2_GETFOLIO_OTHER)]			= "file_alloc_order2_getfolio_other",
		[I(FILE_ALLOC_ORDER0_BUFFERED_READ)]			= "file_alloc_order0_buffered_read",
		[I(FILE_ALLOC_ORDER2_BUFFERED_READ)]			= "file_alloc_order2_buffered_read",
		[I(FILE_ALLOC_ORDER0_READ_CACHE)]			= "file_alloc_order0_read_cache",
		[I(FILE_ALLOC_ORDER2_READ_CACHE)]			= "file_alloc_order2_read_cache",
		[I(UFFD_MFILL_ORDER2_ATTEMPT_COPY)]			= "uffd_mfill_order2_attempt_copy",
		[I(UFFD_MFILL_ORDER2_ATTEMPT_ZEROPAGE)]			= "uffd_mfill_order2_attempt_zeropage",
		[I(UFFD_MFILL_ORDER2_SUCCESS_COPY)]			= "uffd_mfill_order2_success_copy",
		[I(UFFD_MFILL_ORDER2_SUCCESS_ZEROPAGE)]			= "uffd_mfill_order2_success_zeropage",
			[I(UFFD_MFILL_ORDER0_SUCCESS_COPY)]			= "uffd_mfill_order0_success_copy",
			[I(UFFD_MFILL_ORDER0_SUCCESS_ZEROPAGE)]			= "uffd_mfill_order0_success_zeropage",
			[I(ORDER0_BINDER_BUFFER_PAGE)]			= "order0_binder_buffer_page",
			[I(ORDER0_TLB_GATHER_BATCH_PAGE)]		= "order0_tlb_gather_batch_page",
			[I(ORDER0_TLB_TABLE_BATCH_PAGE)]			= "order0_tlb_table_batch_page",
			[I(ORDER0_PTE_ALLOC_PAGE)]			= "order0_pte_alloc_page",
			[I(ORDER0_PMD_ALLOC_PAGE)]			= "order0_pmd_alloc_page",
			[I(ORDER0_VMALLOC_PAGE)]				= "order0_vmalloc_page",
			[I(ORDER0_SLUB_NEW_SLAB_PAGE)]			= "order0_slub_new_slab_page",
			[I(ORDER0_ZSMALLOC_PAGE)]			= "order0_zsmalloc_page",
			[I(ORDER2_ZSMALLOC_PAGE)]			= "order2_zsmalloc_page",
			[I(DMABUF_ALLOC_ORDER0)]				= "dmabuf_alloc_order0",
			[I(FORK_DUP_TASK_STRUCT_EVENT)]			= "fork_dup_task_struct_event",
			[I(FORK_VMAP_STACK_PAGES_EXPECTED)]		= "fork_vmap_stack_pages_expected",
			[I(FORK_NONVMAP_STACK_ORDER_PAGES)]		= "fork_nonvmap_stack_order_pages",
			[I(SCUDO_VMA_UNSUITABLE_ORDER2)]			= "scudo_vma_unsuitable_order2",
			[I(DALVIK_VMA_UNSUITABLE_ORDER2)]		= "dalvik_vma_unsuitable_order2",
			[I(SCUDO_PTE_OCCUPIED_ORDER2)]			= "scudo_pte_occupied_order2",
			[I(DALVIK_PTE_OCCUPIED_ORDER2)]			= "dalvik_pte_occupied_order2",
			[I(BIONIC_VMA_UNSUITABLE_ORDER2)]		= "bionic_vma_unsuitable_order2",
			[I(MTHP_VMA_UNSUITABLE_ORDER2)]		= "mthp_vma_unsuitable_order2",
			[I(STACK_VMA_UNSUITABLE_ORDER2)]			= "stack_vma_unsuitable_order2",
			[I(OTHER_VMA_UNSUITABLE_ORDER2)]			= "other_vma_unsuitable_order2",
			[I(BIONIC_PTE_OCCUPIED_ORDER2)]			= "bionic_pte_occupied_order2",
			[I(MTHP_VMA_PTE_OCCUPIED_ORDER2)]		= "mthp_vma_pte_occupied_order2",
			[I(STACK_PTE_OCCUPIED_ORDER2)]			= "stack_pte_occupied_order2",
			[I(OTHER_PTE_OCCUPIED_ORDER2)]			= "other_pte_occupied_order2",
			[I(ANON_MTHP_ORDER2_VMA_LEFT_BOUNDARY)]		= "anon_mthp_order2_vma_left_boundary",
			[I(ANON_MTHP_ORDER2_VMA_RIGHT_BOUNDARY)]	= "anon_mthp_order2_vma_right_boundary",
			[I(ANON_MTHP_ORDER2_VMA_TOO_SMALL)]		= "anon_mthp_order2_vma_too_small",
			[I(ANON_MTHP_ORDER2_NOT_ALLOWED_DALVIK)]	= "anon_mthp_order2_not_allowed_dalvik",
			[I(ANON_MTHP_ORDER2_NOT_ALLOWED_SCUDO)]		= "anon_mthp_order2_not_allowed_scudo",
			[I(ANON_MTHP_ORDER2_NOT_ALLOWED_BIONIC)]	= "anon_mthp_order2_not_allowed_bionic",
			[I(ANON_MTHP_ORDER2_NOT_ALLOWED_MTHP_VMA)]	= "anon_mthp_order2_not_allowed_mthp_vma",
			[I(ANON_MTHP_ORDER2_NOT_ALLOWED_STACK)]		= "anon_mthp_order2_not_allowed_stack",
			[I(ANON_MTHP_ORDER2_NOT_ALLOWED_OTHER)]		= "anon_mthp_order2_not_allowed_other",
			[I(ANON_FAULT_ORDER0_CLASS_DALVIK)]		= "anon_fault_order0_class_dalvik",
			[I(ANON_FAULT_ORDER0_CLASS_SCUDO)]		= "anon_fault_order0_class_scudo",
			[I(ANON_FAULT_ORDER0_CLASS_BIONIC)]		= "anon_fault_order0_class_bionic",
			[I(ANON_FAULT_ORDER0_CLASS_MTHP_VMA)]		= "anon_fault_order0_class_mthp_vma",
			[I(ANON_FAULT_ORDER0_CLASS_STACK)]		= "anon_fault_order0_class_stack",
			[I(ANON_FAULT_ORDER0_CLASS_OTHER)]		= "anon_fault_order0_class_other",
			[I(ANON_MTHP_ORDER2_UFFD_ARMED)]		= "anon_mthp_order2_uffd_armed",
			[I(ANON_MTHP_ORDER2_VMA_NOT_ALLOWED)]		= "anon_mthp_order2_vma_not_allowed",
			[I(ANON_MTHP_ORDER2_VMA_SUITABLE_FILTERED)]	= "anon_mthp_order2_vma_suitable_filtered",
			[I(ANON_MTHP_ORDER2_PTE_RANGE_NOT_EMPTY)]	= "anon_mthp_order2_pte_range_not_empty",
			[I(ANON_MTHP_ORDER2_ALLOC_FAIL)]		= "anon_mthp_order2_alloc_fail",
			[I(ANON_MTHP_ORDER2_MEMCG_FAIL)]		= "anon_mthp_order2_memcg_fail",
			[I(COW_MTHP_ORDER2_FALLBACK_OLD_FOLIO_NOT_ORDER2)] = "cow_mthp_order2_fallback_old_folio_not_order2",
			[I(COW_MTHP_ORDER2_FALLBACK_VMA_NOT_ALLOWED)]	= "cow_mthp_order2_fallback_vma_not_allowed",
			[I(COW_MTHP_ORDER2_FALLBACK_ALLOC_FAIL)]	= "cow_mthp_order2_fallback_alloc_fail",
			[I(COW_MTHP_ORDER2_FALLBACK_PTE_CHANGED_OR_UNUSABLE)] = "cow_mthp_order2_fallback_pte_changed_or_unusable",
		#endif
