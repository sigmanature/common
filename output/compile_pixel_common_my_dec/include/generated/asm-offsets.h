...
#define THREAD_SCTLR_USER 4496 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 4392 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 4472 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 4488 /* offsetof(struct task_struct, thread.mte_ctrl) */
