...
static int __ext4_fill_super(struct fs_context *fc, struct super_block *sb)
{
	...
	sbi->s_inode_readahead_blks = EXT4_DEF_INODE_READAHEAD_BLKS;
	sbi->s_min_folio_order_cap = fs_disable_large_folio ? 0 : ext4_min_folio_order_cap;
	sbi->s_max_folio_order_cap = fs_disable_large_folio ? 0 : ext4_max_folio_order_cap;
